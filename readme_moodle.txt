...
* remove folder theme/minusone/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/minusone/scss/bootstrap
...
* comment out this line in theme/minusone/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/minusone/amd/src/bootstrap (including the subfolder)
...
* in folder theme/minusone run "Grunt amd" to compile the bootstrap JS
